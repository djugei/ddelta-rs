...
use zerocopy::{BigEndian, Immutable, KnownLayout};
use zerocopy::{FromBytes, IntoBytes, Unaligned, I64, U64};
...
#[derive(Debug, Copy, Clone, FromBytes, IntoBytes, Unaligned, KnownLayout, Immutable)]
#[repr(C)]
struct PatchHeader {
    magic: [u8; 8],
